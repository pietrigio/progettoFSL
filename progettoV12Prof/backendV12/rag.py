...
import json
import shutil
import fitz  # 🔥 AGGIUNTO per leggere PDF

BASE_DIR = os.path.dirname(os.path.abspath(__file__))
INDEX_ROOT = os.path.join(BASE_DIR, "data", "indexes")
CHUNK_SIZE = 500
